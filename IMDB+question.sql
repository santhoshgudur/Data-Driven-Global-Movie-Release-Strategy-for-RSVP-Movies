...
/* There are totally 6 tables in the given schema:
show tables;
...
Output:
-------
movie_count	name_count	ratings_count	role_mappings_count	genre_count	director_count
--------------------------------------------------------------------------------------
7997	    25735	    7997	        15615	            14662	    3867
*/
...
Summary:
--------
Highest number of movies are produced in the March month.
...
Summary: 
--------
There are 13 unique genres present in the data set.
...
Summary:
--------
Drama genre has totally 4285 movies produced and has the highest number of movies produced.
...
Summary:
--------
Thriller genre has 3rd rank with a movie count of 1484
...
-- top 10 movies can also be displayed using WHERE caluse with CTE using ROW_NUMBER()
WITH MOVIE_RANK AS
(
SELECT     title,
           avg_rating,
...
Summary:
--------
Dream Warrior Pictures and National Theatre Live production houses has produced the most number of hit movies (average rating > 8). They have rank of 1 with a movie count of 3. 
...
Summary:
--------
Drama genre has released 24 movies during March 2017 in the USA and had more than 1,000 votes
...
Summary:
--------
German movies received the highest number of votes when queried against language and country columns.
...
Summary:
height, date_of_birth, and known_for_movies columns contain NULL values.
*/
